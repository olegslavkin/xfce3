...
clock_make_popup (MyGtkClock * clockw)
{
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (toggle_menubar_cb), (gpointer) clockw);
  ...
  gtk_widget_show (menuitem);
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (quit_cb), (gpointer) clockw);
...
create_menu (MyGtkClock * clockw)
{
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (toggle_digital_cb), (gpointer) clockw);
  ...
  GTK_CHECK_MENU_ITEM (menuitem)->active =
    my_gtk_clock_military_shown (MY_GTK_CLOCK (clockw));
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
  ...
  GTK_CHECK_MENU_ITEM (menuitem)->active =
    my_gtk_clock_ampm_shown (MY_GTK_CLOCK (clockw));
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (toggle_ampm_cb), (gpointer) clockw);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  GTK_CHECK_MENU_ITEM (menuitem)->active =
    my_gtk_clock_secs_shown (MY_GTK_CLOCK (clockw));
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (toggle_secs_cb), (gpointer) clockw);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (background_cb), (gpointer) clockw);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);

  menuitem = gtk_menu_item_new_with_label (_("Foreground color..."));
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (foreground_cb), (gpointer) clockw);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);

  menuitem = gtk_menu_item_new_with_label (_("Font..."));
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
		      GTK_SIGNAL_FUNC (font_cb), (gpointer) clockw);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
                    GTK_SIGNAL_FUNC (toggle_friday_cb),NULL);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
                    GTK_SIGNAL_FUNC (toggle_saturday_cb),NULL);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
            GTK_SIGNAL_FUNC (toggle_sunday_cb),NULL);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
                    GTK_SIGNAL_FUNC (show_days_cb), NULL);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
                                    GTK_SIGNAL_FUNC (show_heading_cb), NULL);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
  ...
  gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
                                    GTK_SIGNAL_FUNC (start_monday_cb), NULL);
  gtk_check_menu_item_set_show_toggle (GTK_CHECK_MENU_ITEM (menuitem), 1);
  gtk_menu_append (GTK_MENU (menu), menuitem);
  gtk_widget_show (menuitem);
