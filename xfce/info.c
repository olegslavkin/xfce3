...
gboolean
info_private_delete_event (GtkWidget * widget,
...
create_info (void)
{
  ...
  gtk_object_set_data (GTK_OBJECT (info), "info_logo_pixmap",
		       info_logo_pixmap);
  ...
  gtk_object_set_data (GTK_OBJECT (info), "info_centralframe",
		       info_centralframe);
  ...
  info_copyright_label =
    gtk_label_new (_("By Olivier Fourdan (c) 1997-2000"));
  gtk_widget_set_name (info_copyright_label, "info_copyright_label");
  gtk_object_set_data (GTK_OBJECT (info), "info_copyright_label",
		       info_copyright_label);
  ...
  gtk_object_set_data (GTK_OBJECT (info), "info_bottomframe",
		       info_bottomframe);
  ...
  gtk_object_set_data (GTK_OBJECT (info), "info_license_text",
		       info_license_text);
  ...
  if (infile)
      ...
      while (1)
	{
      ...
      gtk_text_insert (GTK_TEXT (info_license_text), NULL, NULL,
  ...
  gtk_object_set_data (GTK_OBJECT (info), "info_agreement_button",
		       info_agreement_button);
  gtk_widget_show (info_agreement_button);
  gtk_box_pack_start (GTK_BOX (info_vbox), info_agreement_button, FALSE,
		      FALSE, 0);
  ...
  gtk_signal_connect (GTK_OBJECT (info_agreement_button), "clicked",
		      GTK_SIGNAL_FUNC (info_private_ok_cb), NULL);

  gtk_signal_connect (GTK_OBJECT (info), "delete_event",
		      GTK_SIGNAL_FUNC (info_private_delete_event), NULL);
