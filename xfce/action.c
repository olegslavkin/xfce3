...
create_action (void)
{
  ...
  gtk_object_set_data (GTK_OBJECT (action), "action_mainframe",
		       action_mainframe);
  ...
  gtk_object_set_data (GTK_OBJECT (action), "actopn_topframe",
		       actopn_topframe);
  ...
  gtk_object_set_data (GTK_OBJECT (action), "action_command_label",
		       action_command_label);
  gtk_widget_show (action_command_label);
  gtk_table_attach (GTK_TABLE (action_table), action_command_label, 0, 1, 0,
  ...
  gtk_object_set_data (GTK_OBJECT (action), "action_icon_label",
		       action_icon_label);
  gtk_widget_show (action_icon_label);
  gtk_table_attach (GTK_TABLE (action_table), action_icon_label, 0, 1, 1, 2,
  ...
  gtk_object_set_data (GTK_OBJECT (action), "action_command_entry",
		       action_command_entry);
  gtk_widget_show (action_command_entry);
  gtk_table_attach (GTK_TABLE (action_table), action_command_entry, 1, 2, 0,
		    1, (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);

  action_icon_optionmenu = gtk_option_menu_new ();
  gtk_widget_set_name (action_icon_optionmenu, "action_icon_optionmenu");
  gtk_object_set_data (GTK_OBJECT (action), "action_icon_optionmenu",
		       action_icon_optionmenu);
  gtk_widget_show (action_icon_optionmenu);
  gtk_table_attach (GTK_TABLE (action_table), action_icon_optionmenu, 1, 2, 1,
		    2, (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND, 0, 0);
  action_icon_optionmenu_menu = gtk_menu_new ();
  gtk_option_menu_set_menu (GTK_OPTION_MENU (action_icon_optionmenu),
			    action_icon_optionmenu_menu);

  action_icon_browse_button = gtk_button_new_with_label (_("Browse ..."));
  gtk_widget_set_name (action_icon_browse_button,
		       "action_icon_browse_button");
  gtk_object_set_data (GTK_OBJECT (action), "action_icon_browse_button",
		       action_icon_browse_button);
  gtk_widget_show (action_icon_browse_button);
  gtk_table_attach (GTK_TABLE (action_table), action_icon_browse_button, 2, 3,
  ...
  gtk_widget_set_name (action_command_browse_button,
		       "action_command_browse_button");
  gtk_object_set_data (GTK_OBJECT (action), "action_command_browse_button",
		       action_command_browse_button);
  gtk_widget_show (action_command_browse_button);
  gtk_table_attach (GTK_TABLE (action_table), action_command_browse_button, 2,
		    3, 0, 1, (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND, 0, 0);
  gtk_widget_set_usize (action_command_browse_button, 90, -2);
  gtk_container_border_width (GTK_CONTAINER (action_command_browse_button),
			      5);
  ...
  gtk_object_set_data (GTK_OBJECT (action), "action_bottom_frame",
		       action_bottom_frame);
  gtk_widget_show (action_bottom_frame);
  gtk_box_pack_start (GTK_BOX (action_vbox), action_bottom_frame, FALSE, TRUE,
		      0);
  ...
  gtk_object_set_data (GTK_OBJECT (action), "action_cancel_button",
  ...
  gtk_widget_add_accelerator (action_ok_button, "clicked", accel_group,
  ...
  gtk_widget_add_accelerator (action_cancel_button, "clicked", accel_group,
			      GDK_Escape, 0, GTK_ACCEL_VISIBLE);
  gtk_widget_add_accelerator (action_cancel_button, "clicked", accel_group,
			      GDK_c, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

  gtk_signal_connect (GTK_OBJECT (action), "delete_event",
		      GTK_SIGNAL_FUNC (action_delete_event), NULL);

  gtk_signal_connect (GTK_OBJECT (action_cancel_button), "clicked",
		      GTK_SIGNAL_FUNC (action_cancel_cb), NULL);

  gtk_signal_connect (GTK_OBJECT (action_command_browse_button), "clicked",
		      GTK_SIGNAL_FUNC (action_browse_command_cb), NULL);
  ...
  if (name && strlen (name))
    {
      ...
      gtk_signal_connect (GTK_OBJECT (menuitem), "activate",
			  GTK_SIGNAL_FUNC
			  (private_action_update_menuentry_cb),
...
{
  gtk_option_menu_set_history (GTK_OPTION_MENU (action_icon_optionmenu),
			       index);
...
open_action (GtkWidget * action, gint nbr)
{
  ...
  action_signal_id1 =
    gtk_signal_connect (GTK_OBJECT (action_ok_button), "clicked",
			GTK_SIGNAL_FUNC (action_ok_cb), 
                        (gpointer)((long) nbr));
  action_signal_id2 =
    gtk_signal_connect (GTK_OBJECT (action_icon_browse_button), "clicked",
			GTK_SIGNAL_FUNC (action_browse_icon_cb),
			(gpointer)((long) nbr));
