...
update_gxfce_size (void)
{
  ...
  for (i = 0; i < NBSELECTS; i++)
    {
      ...
      gtk_container_border_width (GTK_CONTAINER
			        (select_buttons.select_button[i]), ((size == 0) ? 0 : 2));
    }
   ...
   */
  reorganize_table ((GtkTable *) (screen_buttons.desktops_table), 
                    screen_buttons.screen_frame, 
                    NBSCREENS, 
                    (size == 0) ? 1 : 2);
  reorganize_table ((GtkTable *) (gxfce_leftbuttons_table), 
                    gxfce_leftbuttons, 
                    2, 
                    (size == 0) ? 1 : 2);
  reorganize_table ((GtkTable *) (gxfce_rightbuttons_table), 
                    gxfce_rightbuttons, 
                    2, 
                    (size == 0) ? 1 : 2);
...
create_gxfce_popup_button (GtkWidget * toplevel, gint nbr)
{
...
#ifndef OLD_STYLE
  gtk_button_set_relief ((GtkButton *) popup_buttons.popup_button[nbr],
			 GTK_RELIEF_NONE);
  ...
  gtk_signal_connect (GTK_OBJECT (popup_buttons.popup_button[nbr]), "clicked",
		      GTK_SIGNAL_FUNC (popup_cb), (gpointer)((long) nbr));

  return popup_buttons.popup_button[nbr];
}

GtkWidget *
create_gxfce_select_button (GtkWidget * toplevel,
			    gint nbr)
{
  gint size = current_config.select_icon_size;
  ...
  gtk_widget_set_usize (select_buttons.select_button[nbr], PANEL_ICON_SIZE,
			PANEL_ICON_SIZE);
  gtk_container_border_width (GTK_CONTAINER
			      (select_buttons.select_button[nbr]), ((size == 0) ? 1 : 2));
  ...
  for (i = 0; i < NBSCREENS; i++)
    {
      ...
      gtk_container_border_width (GTK_CONTAINER
				  (screen_buttons.screen_frame[i]), 0);
	...
	gtk_radio_button_group (GTK_RADIO_BUTTON
      ...
      gtk_signal_connect (GTK_OBJECT (screen_buttons.screen_button[i]),
			  "button_press_event",
			  GTK_SIGNAL_FUNC (screen_modify_cb), 
                          (gpointer)((long) i));
      gtk_signal_connect (GTK_OBJECT (screen_buttons.screen_button[i]),
...
void reorganize_table (GtkTable *tbl, GtkWidget **w, guint nitems, guint rows)
{
  GtkTableChild *child;
  GList *tmp;
  guint i;
...
create_gxfce (XFCE_palette *pal)
{
...
#ifndef OLD_STYLE
  gtk_button_set_relief ((GtkButton *) gxfce_close_button,
			 GTK_RELIEF_NONE);
  ...
  gtk_object_set_data (GTK_OBJECT (gxfce), "gxfce_leftbuttons_table",
		       gxfce_leftbuttons_table);
  gtk_widget_show (gxfce_leftbuttons_table);
  gtk_box_pack_start (GTK_BOX (gxfce_central_hbox), gxfce_leftbuttons_table,
		      FALSE, TRUE, 0);
  ...
  gtk_table_attach (GTK_TABLE (gxfce_leftbuttons_table),
		    select_buttons.select_button[NBSELECTS], 0, 1, 0, 1,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL | GTK_SHRINK,
		    (GtkAttachOptions) GTK_EXPAND | GTK_SHRINK,
		     0, 0);
  gtk_container_border_width (GTK_CONTAINER
  ...
  gtk_box_pack_start (GTK_BOX (gxfce_central_hbox), screen_buttons.desktops_table, TRUE,
		      TRUE, 0);

  gxfce_rightbuttons_table = gtk_table_new (2, 2, FALSE);
  gtk_widget_set_name (gxfce_rightbuttons_table, "gxfce_rightbuttons_table");
  gtk_object_set_data (GTK_OBJECT (gxfce), "gxfce_rightbuttons_table",
		       gxfce_rightbuttons_table);
  gtk_widget_show (gxfce_rightbuttons_table);
  gtk_box_pack_start (GTK_BOX (gxfce_central_hbox), gxfce_rightbuttons_table,
		      FALSE, TRUE, 0);
...
#ifndef OLD_STYLE
  gtk_button_set_relief ((GtkButton *) gxfce_iconify_button,
			 GTK_RELIEF_NONE);
