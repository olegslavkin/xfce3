...
create_modify ()
{
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_mainframe",
		       modify_mainframe);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_leftframe",
		       modify_leftframe);
  gtk_widget_show (modify_leftframe);
  gtk_box_pack_start (GTK_BOX (modify_hbox), modify_leftframe, FALSE, TRUE,
		      0);
  ...
  gtk_object_set_data (GTK_OBJECT (modify_preview_frame),
		       "modify_preview_frame", modify_preview_frame);
  ...
  gtk_box_pack_start (GTK_BOX (modify_vbox2), modify_preview_frame, FALSE,
		      TRUE, 0);
  gtk_widget_set_usize (modify_preview_frame, 80, 80);

  modify_preview_pixmap =
    MyCreateFromPixmapData (modify_preview_frame, empty);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_preview_pixmap",
		       modify_preview_pixmap);
  gtk_widget_show (modify_preview_pixmap);
  gtk_container_add (GTK_CONTAINER (modify_preview_frame),
		     modify_preview_pixmap);

  modify_preview_label = gtk_label_new (_("Preview Icon"));
  gtk_widget_set_name (modify_preview_label, "modify_preview_label");
  gtk_object_set_data (GTK_OBJECT (modify), "modify_preview_label",
		       modify_preview_label);
  gtk_widget_show (modify_preview_label);
  gtk_box_pack_start (GTK_BOX (modify_vbox2), modify_preview_label, FALSE,
		      FALSE, 0);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_rightframe",
		       modify_rightframe);
  gtk_widget_show (modify_rightframe);
  gtk_box_pack_start (GTK_BOX (modify_hbox), modify_rightframe, TRUE, TRUE,
		      0);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_command_label",
		       modify_command_label);
  gtk_widget_show (modify_command_label);
  gtk_table_attach (GTK_TABLE (modify_table), modify_command_label, 0, 1, 0,
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_icon_label",
		       modify_icon_label);
  gtk_widget_show (modify_icon_label);
  gtk_table_attach (GTK_TABLE (modify_table), modify_icon_label, 0, 1, 1, 2,
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_displayed_label",
		       modify_displayed_label);
  gtk_widget_show (modify_displayed_label);
  gtk_table_attach (GTK_TABLE (modify_table), modify_displayed_label, 0, 1, 2,
		    3, (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);
  gtk_label_set_justify (GTK_LABEL (modify_displayed_label),
			 GTK_JUSTIFY_RIGHT);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_command_entry",
		       modify_command_entry);
  gtk_widget_show (modify_command_entry);
  gtk_table_attach (GTK_TABLE (modify_table), modify_command_entry, 1, 2, 0,
		    1, (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);

  modify_icon_entry = gtk_entry_new ();
  gtk_widget_set_name (modify_icon_entry, "modify_icon_entry");
  gtk_object_set_data (GTK_OBJECT (modify), "modify_icon_entry",
		       modify_icon_entry);
  gtk_widget_show (modify_icon_entry);
  gtk_table_attach (GTK_TABLE (modify_table), modify_icon_entry, 1, 2, 1, 2,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);

  modify_displayed_entry = gtk_entry_new ();
  gtk_widget_set_name (modify_displayed_entry, "modify_displayed_entry");
  gtk_object_set_data (GTK_OBJECT (modify), "modify_displayed_entry",
		       modify_displayed_entry);
  gtk_widget_show (modify_displayed_entry);
  gtk_table_attach (GTK_TABLE (modify_table), modify_displayed_entry, 1, 2, 2,
		    3, (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL, 0, 0);

  modify_command_browse_button = gtk_button_new_with_label (_("Browse ..."));
  gtk_widget_set_name (modify_command_browse_button,
		       "modify_command_browse_button");
  gtk_object_set_data (GTK_OBJECT (modify), "modify_command_browse_button",
		       modify_command_browse_button);
  gtk_widget_show (modify_command_browse_button);
  gtk_table_attach (GTK_TABLE (modify_table), modify_command_browse_button, 2,
		    3, 0, 1, (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND, 0, 0);
  gtk_widget_set_usize (modify_command_browse_button, 90, -2);
  gtk_container_border_width (GTK_CONTAINER (modify_command_browse_button),
			      5);

  modify_icon_browse_button = gtk_button_new_with_label (_("Browse ..."));
  gtk_widget_set_name (modify_icon_browse_button,
		       "modify_icon_browse_button");
  gtk_object_set_data (GTK_OBJECT (modify), "modify_icon_browse_button",
		       modify_icon_browse_button);
  gtk_widget_show (modify_icon_browse_button);
  gtk_table_attach (GTK_TABLE (modify_table), modify_icon_browse_button, 2, 3,
  ...
  gtk_table_attach (GTK_TABLE (modify_table), modify_packer, 2, 3, 2, 3,
		    (GtkAttachOptions) GTK_EXPAND | GTK_FILL,
		    (GtkAttachOptions) GTK_EXPAND, 0, 0);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_bottomframe",
		       modify_bottomframe);
  gtk_widget_show (modify_bottomframe);
  gtk_box_pack_start (GTK_BOX (modify_vbox), modify_bottomframe, FALSE, TRUE,
		      0);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_remove_button",
		       modify_remove_button);
  ...
  gtk_object_set_data (GTK_OBJECT (modify), "modify_cancel_button",
  ...
  gtk_widget_add_accelerator (modify_ok_button, "clicked", accel_group,
  ...
  gtk_widget_add_accelerator (modify_cancel_button, "clicked", accel_group,
			      GDK_Escape, 0, GTK_ACCEL_VISIBLE);
  gtk_widget_add_accelerator (modify_cancel_button, "clicked", accel_group,
			      GDK_c, GDK_CONTROL_MASK, GTK_ACCEL_VISIBLE);

  gtk_widget_add_accelerator (modify_remove_button, "clicked", accel_group,
			      GDK_Delete, GDK_CONTROL_MASK,
			      GTK_ACCEL_VISIBLE);

  gtk_signal_connect (GTK_OBJECT (modify), "delete_event",
		      GTK_SIGNAL_FUNC (modify_delete_event), NULL);

  gtk_signal_connect (GTK_OBJECT (modify_cancel_button), "clicked",
		      GTK_SIGNAL_FUNC (modify_cancel_cb), NULL);

  gtk_signal_connect (GTK_OBJECT (modify_command_browse_button), "clicked",
		      GTK_SIGNAL_FUNC (modify_browse_command_cb), NULL);

  gtk_signal_connect (GTK_OBJECT (modify_icon_browse_button), "clicked",
		      GTK_SIGNAL_FUNC (modify_browse_icon_cb), NULL);
  ...
  if (item < 0)
    {
      ...
      signal_id1 =
	gtk_signal_connect (GTK_OBJECT (modify_ok_button), "clicked",
			    GTK_SIGNAL_FUNC (modify_add_cb),
			    (gpointer)((long) (menu * NBMAXITEMS)));

      signal_id2 =
	gtk_signal_connect (GTK_OBJECT (modify_remove_button), "clicked",
			    GTK_SIGNAL_FUNC (modify_cancel_cb),
			    (gpointer)((long) (menu * NBMAXITEMS)));
    }
  else
    {
      gtk_window_set_title (GTK_WINDOW (modify), _("Modify Item ..."));
      gtk_entry_set_text (GTK_ENTRY (modify_command_entry),
			  get_popup_entry_command (menu, item));
      gtk_entry_set_text (GTK_ENTRY (modify_displayed_entry),
			  get_popup_entry_label (menu, item));
      ...
      else
	{
      ...
      signal_id1 =
	gtk_signal_connect (GTK_OBJECT (modify_ok_button), "clicked",
			    GTK_SIGNAL_FUNC (modify_change_cb),
			    (gpointer)((long) (menu * NBMAXITEMS + item)));

      signal_id2 =
	gtk_signal_connect (GTK_OBJECT (modify_remove_button), "clicked",
			    GTK_SIGNAL_FUNC (modify_remove_cb),
			    (gpointer)((long) (menu * NBMAXITEMS + item)));
    }
