...
create_xfumed_window (XFMENU *xfmenu)
{
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "vbox1", vbox1,
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "hbox1", hbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "vbox2", vbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "scrolledwindow1", scrolledwindow1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "ctree", ctree,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "caption_label", caption_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "cmd_label", cmd_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "action_frame", action_frame,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "vbuttonbox1", vbuttonbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "up_button", up_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "down_button", down_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "add_button", add_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "edit_button", edit_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "remove_button", remove_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "hseparator1", hseparator1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "hbuttonbox1", hbuttonbox1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "save_button", save_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "reset_button", reset_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed_window), "quit_button", quit_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (quit_button);
  gtk_container_add (GTK_CONTAINER (hbuttonbox1), quit_button);
  GTK_WIDGET_SET_FLAGS (quit_button, GTK_CAN_DEFAULT);

  gtk_signal_connect (GTK_OBJECT (xfumed_window), "delete_event",
                      GTK_SIGNAL_FUNC (on_xfumed_window_delete_event),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (xfumed_window), "destroy_event",
                      GTK_SIGNAL_FUNC (on_xfumed_window_destroy_event),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "tree_select_row",
                      GTK_SIGNAL_FUNC (on_ctree_tree_select_row),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "tree_unselect_row",
                      GTK_SIGNAL_FUNC (on_ctree_tree_unselect_row),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "drag_begin",
                      GTK_SIGNAL_FUNC (on_ctree_drag_begin),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "drag_data_get",
                      GTK_SIGNAL_FUNC (on_ctree_drag_data_get),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "drag_data_received",
                      GTK_SIGNAL_FUNC (on_ctree_drag_data_received),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "drag_end",
                      GTK_SIGNAL_FUNC (on_ctree_drag_end),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "button_press_event",
                      GTK_SIGNAL_FUNC (on_ctree_button_press_event),
                      xfmenu);
  gtk_signal_connect_after (GTK_OBJECT (ctree), "button_release_event",
                      GTK_SIGNAL_FUNC (on_ctree_button_release_event),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (ctree), "key_press_event",
                      GTK_SIGNAL_FUNC (on_ctree_key_press_event),
                      xfmenu);
  ...
  gtk_signal_connect (GTK_OBJECT (quit_button), "clicked",
	...
	gtk_drag_dest_set (ctree, GTK_DEST_DEFAULT_MOTION | 
	                   GTK_DEST_DEFAULT_HIGHLIGHT | GTK_DEST_DEFAULT_DROP,
			   target_entry, 1, GDK_ACTION_MOVE);
...
create_edit_dialog (XFMENU *xfmenu)
{
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "hbox2", hbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "table1", table1,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "type_label", type_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (type_label);
  gtk_table_attach (GTK_TABLE (table1), type_label, 0, 1, 0, 1,
  ...
  caption_label = gtk_label_new (_("Caption: "));
  gtk_widget_ref (caption_label);
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "caption_label", caption_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (caption_label);
  gtk_table_attach (GTK_TABLE (table1), caption_label, 0, 1, 1, 2,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "command_label", command_label,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (command_label);
  gtk_table_attach (GTK_TABLE (table1), command_label, 0, 1, 2, 3,
                    (GtkAttachOptions) (GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "item_combo", item_combo,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (item_combo);
  gtk_table_attach (GTK_TABLE (table1), item_combo, 1, 2, 0, 1,
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "item_entry", item_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "caption_entry", caption_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (caption_entry);
  gtk_table_attach (GTK_TABLE (table1), caption_entry, 1, 2, 1, 2,
                    (GtkAttachOptions) (GTK_EXPAND | GTK_FILL),
                    (GtkAttachOptions) (0), 0, 0);

  hbox3 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox3);
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "hbox3", hbox3,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "cmd_entry", cmd_entry,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "fileselect_button", fileselect_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "hbuttonbox2", hbuttonbox2,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "dlg_ok_button", dlg_ok_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (edit_dialog), "dlg_cancel_button", dlg_cancel_button,
                            (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_signal_connect (GTK_OBJECT (edit_dialog), "key_press_event",
                      GTK_SIGNAL_FUNC (on_edit_dialog_key_press_event),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (fileselect_button), "clicked",
                      GTK_SIGNAL_FUNC (on_fileselect_button_clicked),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (dlg_ok_button), "clicked",
                      GTK_SIGNAL_FUNC (on_dlg_ok_button_clicked),
                      xfmenu);
  gtk_signal_connect (GTK_OBJECT (dlg_cancel_button), "clicked",
                      GTK_SIGNAL_FUNC (on_dlg_cancel_button_clicked),
                      xfmenu);

  gtk_signal_connect (GTK_OBJECT (item_entry), "changed",
                      GTK_SIGNAL_FUNC (on_item_entry_changed),
                      xfmenu);
  ...
  gtk_widget_grab_default (dlg_ok_button);
	...
	if (dlg->update) {
		...
		gtk_ctree_node_get_pixtext (GTK_CTREE (xfmenu->ctree), node, 
		                            0, &caption, NULL, NULL, NULL);
