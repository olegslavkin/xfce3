...
/*  GtkWidget *button_fileselect; */
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "vbox1", vbox1, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox1);
  gtk_container_add (GTK_CONTAINER (xfumed), vbox1);

  hbox1 = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox1);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "hbox1", hbox1, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox1);
  gtk_box_pack_start (GTK_BOX (vbox1), hbox1, TRUE, TRUE, 0);

  vbox2 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox2);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "vbox2", vbox2, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vbox2);
  gtk_box_pack_start (GTK_BOX (hbox1), vbox2, TRUE, TRUE, 0);

  frame_status = gtk_frame_new (NULL);
  gtk_widget_ref (frame_status);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "frame_status", frame_status, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "hbox_status", hbox_status, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_status", label_status, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "hbuttonbox2", hbuttonbox2, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_to_parent", button_to_parent, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_to_sub", button_to_sub, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "scrolledwindow1", scrolledwindow1, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "clist_menuitems", clist_menuitems, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_col1", label_col1, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_col2", label_col2, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_col3", label_col3, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label_col3);
  gtk_clist_set_column_widget (GTK_CLIST (clist_menuitems), 2, label_col3);

  hbuttonbox3 = gtk_hbutton_box_new ();
  gtk_widget_ref (hbuttonbox3);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "hbuttonbox3", hbuttonbox3, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_up", button_up, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "arrow_up", arrow_up, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_down", button_down, (GtkDestroyNotify) gtk_widget_unref);

  arrow_down = gtk_arrow_new (GTK_ARROW_DOWN, GTK_SHADOW_IN);
  gtk_widget_ref (arrow_down);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "arrow_down", arrow_down, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "vseparator1", vseparator1, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (vseparator1);
  gtk_box_pack_start (GTK_BOX (hbox1), vseparator1, FALSE, TRUE, 4);

  vbox3 = gtk_vbox_new (FALSE, 0);
  gtk_widget_ref (vbox3);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "vbox3", vbox3, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_edit_section", label_edit_section, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "table_entries", table_entries, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_type", label_type, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label_type);
  gtk_table_attach (GTK_TABLE (table_entries), label_type, 0, 1, 0, 1, (GtkAttachOptions) (GTK_FILL), (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_caption", label_caption, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label_caption);
  gtk_table_attach (GTK_TABLE (table_entries), label_caption, 0, 1, 1, 2, (GtkAttachOptions) (GTK_FILL), (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "label_command", label_command, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (label_command);
  gtk_table_attach (GTK_TABLE (table_entries), label_command, 0, 1, 2, 3, (GtkAttachOptions) (GTK_FILL), (GtkAttachOptions) (0), 0, 0);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "combo_type", combo_type, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (combo_type);
  gtk_table_attach (GTK_TABLE (table_entries), combo_type, 1, 2, 0, 1, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);
  gtk_combo_set_value_in_list (GTK_COMBO (combo_type), TRUE, FALSE);
  combo_type_items = g_list_append (combo_type_items, (gpointer) TYPE_ITEM_TEXT);
  combo_type_items = g_list_append (combo_type_items, (gpointer) TYPE_SUBMENU_TEXT);
  combo_type_items = g_list_append (combo_type_items, (gpointer) TYPE_NOP_TEXT);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "combo_entry_type", combo_entry_type, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "entry_caption", entry_caption, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (entry_caption);
  gtk_table_attach (GTK_TABLE (table_entries), entry_caption, 1, 2, 1, 2, (GtkAttachOptions) (GTK_EXPAND | GTK_FILL), (GtkAttachOptions) (0), 0, 0);

  hbox_command = gtk_hbox_new (FALSE, 0);
  gtk_widget_ref (hbox_command);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "hbox_command", hbox_command, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hbox_command);
  gtk_table_attach (GTK_TABLE (table_entries), hbox_command, 1, 2, 2, 3, (GtkAttachOptions) (GTK_FILL), (GtkAttachOptions) (GTK_FILL), 0, 0);

  entry_command = gtk_entry_new ();
  gtk_widget_ref (entry_command);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "entry_command", entry_command, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_fileselect", button_fileselect, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "vbuttonbox1", vbuttonbox1, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_add", button_add, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_update", button_update, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_remove", button_remove, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "hseparator1", hseparator1, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (hseparator1);
  gtk_box_pack_start (GTK_BOX (vbox1), hseparator1, FALSE, TRUE, 4);

  hbuttonbox1 = gtk_hbutton_box_new ();
  gtk_widget_ref (hbuttonbox1);
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "hbuttonbox1", hbuttonbox1, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_save", button_save, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_reset", button_reset, (GtkDestroyNotify) gtk_widget_unref);
  ...
  gtk_object_set_data_full (GTK_OBJECT (xfumed), "button_quit", button_quit, (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show (button_quit);
  gtk_container_add (GTK_CONTAINER (hbuttonbox1), button_quit);
  GTK_WIDGET_SET_FLAGS (button_quit, GTK_CAN_DEFAULT);

  gtk_signal_connect (GTK_OBJECT (xfumed), "delete_event", GTK_SIGNAL_FUNC (on_xfumed_delete_event), NULL);
  gtk_signal_connect (GTK_OBJECT (xfumed), "destroy_event", GTK_SIGNAL_FUNC (on_xfumed_destroy_event), NULL);
  gtk_signal_connect (GTK_OBJECT (button_to_parent), "clicked", GTK_SIGNAL_FUNC (on_button_to_parent_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_to_sub), "clicked", GTK_SIGNAL_FUNC (on_button_to_sub_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (clist_menuitems), "select_row", GTK_SIGNAL_FUNC (on_clist_menuitems_select_row), NULL);
  gtk_signal_connect (GTK_OBJECT (clist_menuitems), "unselect_row", GTK_SIGNAL_FUNC (on_clist_menuitems_unselect_row), NULL);
  gtk_signal_connect (GTK_OBJECT (button_up), "clicked", GTK_SIGNAL_FUNC (on_button_up_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_down), "clicked", GTK_SIGNAL_FUNC (on_button_down_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (combo_entry_type), "changed", GTK_SIGNAL_FUNC (on_combo_entry1_changed), NULL);
  gtk_signal_connect (GTK_OBJECT (button_fileselect), "clicked", GTK_SIGNAL_FUNC (on_button_fileselect_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_add), "clicked", GTK_SIGNAL_FUNC (on_button_add_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_update), "clicked", GTK_SIGNAL_FUNC (on_button_update_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_remove), "clicked", GTK_SIGNAL_FUNC (on_button_remove_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_save), "clicked", GTK_SIGNAL_FUNC (on_button_save_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_reset), "clicked", GTK_SIGNAL_FUNC (on_button_reset_clicked), NULL);
  gtk_signal_connect (GTK_OBJECT (button_quit), "clicked", GTK_SIGNAL_FUNC (on_button_quit_clicked), NULL);

  return xfumed;
}

GtkWidget *
create_dialog_quit (void)
{
  ...
  buttons[0] = _("Don't Quit");
  buttons[1] = _("Quit, don't save");
   
  signal_handlers[0] = GTK_SIGNAL_FUNC (on_button_cancel_quit_clicked);
  signal_handlers[1] = GTK_SIGNAL_FUNC (on_button_continue_quit_clicked);

  quit_dialog = my_show_dialog (message, nbuttons, buttons, default_button, signal_handlers, NULL);
  gtk_signal_connect (GTK_OBJECT (quit_dialog), "delete_event", GTK_SIGNAL_FUNC (on_quit_dialog_delete), GTK_OBJECT (quit_dialog));
  return quit_dialog;
}
