...
static char radio_bits[] = {
  0x00, 0x00, 0x00, 0x00, 0xe0, 0x00, 0x10, 0x01, 0x08, 0x02, 0x04, 0x04,
  0x04, 0x04, 0x04, 0x04, 0x08, 0x02, 0x10, 0x01, 0xe0, 0x00, 0x00, 0x00,
  0x00, 0x00, };
	   ...
	   gint           height)
{
  ...
  if (strcmp (detail, "check") == 0)	/* Menu item */
    ...
    {
      draw_part (window, style->text_gc[state], area, x, y, CHECK);
	    ...
	    gint           height)
{
  ...
  if (strcmp (detail, "option") == 0)	/* Menu item */
    ...
    {
      draw_part (window, style->text_gc[state], area, x, y, RADIO);
	    ...
	    gint           height)
{
  ...
  if (detail && strcmp (detail, "spinbutton") == 0)
	...
	y += (1 + height - 4) / 2;
      ...
      draw_varrow (window, style->text_gc[state], shadow, area, arrow_type,
		   x, y, 7, 4);
    }
  ...
  else if (detail && strcmp (detail, "hscrollbar") == 0)
    {
      ...
      draw_harrow (window, style->text_gc[state], shadow, area, arrow_type,
		   x, y, 5, 7);
    }
  else
    {
	 ...
	 gint height)
{
  ...
  draw_varrow (window, style->text_gc[state_type], shadow_type, area, GTK_ARROW_UP,
	       x, y, OPTION_INDICATOR_WIDTH, 5);
  draw_varrow (window, style->text_gc[state_type], shadow_type, area, GTK_ARROW_DOWN,
