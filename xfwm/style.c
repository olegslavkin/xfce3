                 ...
                 unsigned long context, char *text, int *Module)
{
    ...
    AddToStyleList (name, icon_name, off_flags, on_flags, desknumber, bw, layer,
               forecolor, backcolor, off_buttons, on_buttons);
}


void
AddToStyleList (char *name,
           char *icon_name,
 ...
 ***********************************************************************/
unsigned long
LookInStyleList (char *name, XClassHint * class, char **value,
            int *Desk, int *border_width, int *layer,
            char **forecolor, char **backcolor, unsigned long *buttons)
{
    name_list *nptr;
