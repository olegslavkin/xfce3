...
void DrawSelectedEntry (Window, int, int, int, int, GC, GC, GC *);
...
void DrawSelectedEntry_xfce (Window, int, int, int, int, GC, GC, GC *);
...
void DrawSelectedEntry_mofit (Window, int, int, int, int, GC, GC, GC *);
...
void DrawSelectedEntry_trench (Window, int, int, int, int, GC, GC, GC *);
